defmodule DineOutsideWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DineOutsideWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DineOutsideWeb.Gettext, "errors", msg, opts)
    end
  end
